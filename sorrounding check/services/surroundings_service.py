...
def analyze_surrounding_land(lat: float, lon: float, radius: int = 1000):
    
    # We added way["highway"] to count the roads!
    query = f"""
    [out:json][timeout:25];
    (
    ...
    for url in OVERPASS_URLS:
        try:
            ...
            total_points = 0.0
            road_count = 0  # <--- New variable to track urban density
            ...
            for el in elements:
                ...
                if "highway" in tags:
                    # Ignore minor dirt tracks/paths when counting urban density
                    if tags["highway"] not in ["track", "path", "footway"]:
                        road_count += 1
                    continue # Skip scoring the road itself

                # Score the actual land
            ...
            # ========================================================
            # THE SMART RURAL DEDUCTION LOGIC
            # ========================================================
            # If the area has very few mapped buildings/zones (total_points < 30)
            # AND it has very few paved roads (road_count < 15), 
            # it is FACTUALLY a rural/agricultural area.
            
           # ========================================================
            # THE SMART RURAL DEDUCTION LOGIC
            # ========================================================
            is_rural = False
            missing_space = 0.0 # Added this so it never crashes!
            ...
            if total_points == 0:
                return {"error": "Absolute zero data found."}
            ...
            # Calculate the true original weight before rural deduction
            ...
            return {
                ...
                "diagnostics": {
                    ...
                    "mapped_structures_weight": round(original_weight, 1) # Perfectly fixed!
                }
            }
